...
from composers import ComposersWindow  # Import the ComposersWindow class
...
class MainApp:
    def __init__(self, root):
        ...
        ttk.Button(root, text="Open Composers Window", command=lambda: self.show_window("Composers")).pack(pady=10)
    ...
    def create_windows(self):
        ...
        self.windows["Composers"] = ComposersWindow(self.root, self)
